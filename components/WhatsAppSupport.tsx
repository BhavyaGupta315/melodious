...
export function WhatsAppSupport() {
  ...
  return (
    <Card className="relative overflow-hidden border-2 border-green-500/20 bg-gradient-to-br from-green-50 to-transparent transition-all duration-300 hover:scale-103 hover:border-green-500">
      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="relative">
          ...
          >
            <Button className="w-full bg-green-500 hover:bg-green-600 text-white hover:scale-101 gap-2 cursor-pointer" size="lg">
