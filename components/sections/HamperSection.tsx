...
const plans = [
  ...
  },
  {
    title: "Premium Plan",
    description:
      "The ultimate personalized experience with a song and fully customized visuals.",
    price: "₹2,599",
    icon: Star,
    features: [
      "2–3 minute custom song",
      ...
      <div className="mx-10">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-[800px] mx-auto">
            Select from our carefully crafted packages, each designed to create
            a unique and memorable experience for your special occasion.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <CardHeader className="relative">
                  <div
                    className={`p-3 rounded-lg inline-flex ${plan.color} mb-4`}
                  >
                    <Icon className={`h-6 w-6 ${plan.iconColor}`} />
                    {plan.popular && (
                        <Badge
                            className="absolute right-4 bg-gradient-to-r from-pink-500 to-rose-500 font-semibold cursor-default"
                            variant="secondary"
                        >
                            Most Purchased ⭐
                        </Badge>
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground">
            All plans include high-quality audio files.
          </p>
        </div>
      </div>
    </section>
