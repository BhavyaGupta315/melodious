...
import { greatVibes } from "@/components/fonts";
...
const occasions = [
  {
    ...
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Leonardo_Kino_XL_A_romantic_candlelit_dinner_setting_under_a_s_3.jpg-suwXDoSLa3GSP2AdxTJrK8joXn4Fi8.jpeg",
  },
  {
    title: "Proposals",
    description: "Make the moment perfect",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Leonardo_Kino_XL_A_magical_sunset_proposal_on_a_secluded_beach_2.jpg-gyEvjFVmi9y548RYQ4HEf39l87vgC7.jpeg",
  },
  {
    title: "Anniversaries",
    description: "Celebrate your special milestones",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Leonardo_Kino_XL_A_romantic_candlelit_dinner_setting_under_a_d_0.jpg-KJHL2G6FxRXcGFPD2xdA4AgXqMGBD8.jpeg",
  },
  {
    title: "Birthdays",
    description: "Create magical birthday memories",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Leonardo_Kino_XL_A_cheerful_birthday_celebration_scene_with_fr_1.jpg-xKBWPMWcHZRCYcWQZ8YFmnfIDWxtiO.jpeg",
  },
  {
    title: "Weddings",
    description: "Make your first dance unforgettable",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Leonardo_Kino_XL_A_vibrant_Indian_outdoor_wedding_ceremony_at_2.jpg-BcNwtx0jEKbDz8zkbiPhrSWog2X0Hd.jpeg",
  },
];
...
export default function HeroSection() {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-pink-50 to-white py-20">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-lg max-w-[600px]">
                Personalized songs and Valentine&apos;s hampers to make your
                moments unforgettable. Create a unique musical gift that will be
                cherished forever.
              </p>
            </div>
          </div>
