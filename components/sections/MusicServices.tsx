        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="pt-4 flex items-center gap-4">
                    ...
                    <Button size="icon" className="h-12 w-12 cursor-pointer hover:bg-[#C9193F]"  onClick={() => setIsPlaying(!isPlaying)}>
                    ...
                    <div className="flex items-center gap-2 ml-auto cursor-pointer">
                        {volume[0] === 0 ? <VolumeOff className="h-4 w-4" onClick={()=>setVolume([10])} /> : <Volume2 className="h-4 w-4" onClick={()=>setVolume([0])}/>}
          ...
          <div className="relative aspect-video rounded-2xl overflow-hidden bg-black">
            <div className="absolute inset-0 flex items-center justify-center">
              <Button size="lg" variant="outline" className="text-white border-white cursor-pointer">
